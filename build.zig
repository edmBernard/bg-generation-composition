...
pub fn build(b: *std.Build) void {
    ...
    const zsvg_dep = b.dependency("zsvg", .{
        .target = target,
        .optimize = optimize,
    });
    ...
    const mod = b.addModule("bg_generation_composition", .{
    ...
    const exe = b.addExecutable(.{
        .name = "bg_generation_composition",
        .root_module = b.createModule(.{
            ...
            // root module.
            .imports = &.{
                // Here "bg_generation_composition" is the name you will use in your source code to
                // import this module (e.g. `@import("bg_generation_composition")`). The name is
